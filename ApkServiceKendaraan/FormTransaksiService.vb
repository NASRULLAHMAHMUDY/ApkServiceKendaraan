...
Public Class FormTransaksiService
    ...
    Sub Otomatis()
        ...
        If Not rd.HasRows Then
            TNomor.Text = "00001"
        Else
            TNomor.Text = Format(Microsoft.VisualBasic.Right(rd.Item("nomor"), 5) + 1, "00000")
        End If
    End Sub
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If Val(tbarisjasa.Text) > Val(tbarisbarang.Text) Then
            ...
            For baris As Integer = 0 To DGVBarang.RowCount - 2
                ...
                rd.Read()
                If rd.HasRows Then
                    cmd = New OdbcCommand("update barang set Stok='" & rd.Item("Stok") - DGVBarang.Rows(baris).Cells(3).Value & "' where Kode_Barang='" & DGVBarang.Rows(baris).Cells(0).Value & "'", conn)
                    cmd.ExecuteNonQuery()
                End If
            Next
        End If
    ...
    Private Sub DGV1_CellMouseClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellMouseEventArgs) Handles DGV1.CellMouseClick
        ...
        rd.Read()
        If rd.HasRows Then
            DGVJasa.Rows(baris).Cells(1).Value = rd.Item("Nama_Jasa")
            DGVJasa.Rows(baris).Cells(2).Value = rd.Item("Harga_Jasa")
    ...
    Private Sub DGV2_CellMouseClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellMouseEventArgs) Handles DGV2.CellMouseClick
        ...
        rd.Read()
        If rd.HasRows Then
            DGVBarang.Rows(baris).Cells(1).Value = rd.Item("Nama_Barang")
            DGVBarang.Rows(baris).Cells(2).Value = rd.Item("Harga_Barang")
